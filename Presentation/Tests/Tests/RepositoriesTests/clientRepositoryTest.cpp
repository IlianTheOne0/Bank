...
//}
//
//void checkByPassport(ClientRepository& clientRepo)
//{
//    long long number = generateRandomLongLong(1000000, 9999999);
//    Client client = { 0, "John", "Doe", to_string(number), "+380" + to_string(number), to_string(number) + "john.doe@example.com", {} };
//    int clientId = clientRepo.add(&client);
//    bool result = clientRepo.checkByPassport(client.passportNumber);
//
//    if (result) { cout << "CheckByPassport test passed." << endl; }
//    else { cout << "CheckByPassport test failed." << endl; }
//
//    result = clientRepo.checkByPassport("12585125821");
//    if (!result) { cout << "CheckByPassport test passed." << endl; }
//    else { cout << "CheckByPassport test failed." << endl; }
//}
//
