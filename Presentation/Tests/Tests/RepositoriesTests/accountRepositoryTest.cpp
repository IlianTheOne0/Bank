...
//    Account account = { 0, 1, 456.45f, "USD", {}, { 0, 0, 0, 1, 0, 121 }, AccountStatus::closed, "password123", false };
//    int accountId = accountRepo.add(&account, "randomSalt");
//
...
//    Account account = { 0, 1, 1000.0f, "USD", {}, { 0, 0, 0, 1, 0, 121 }, AccountStatus::closed, "password123", false };
//    int accountId = accountRepo.add(&account, "randomSalt");
